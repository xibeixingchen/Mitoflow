...
- **Ka/Ks Selection Pressure** — Dual-engine: KaKs_Calculator-3.0 (C++, 7 methods) + Python NG86 fallback; barplot, dotplot, scatter, boxplot, pie chart
...
| `kaks` | Ka/Ks selection pressure (dual engine) |
...
├── kaks/                     # KaKs_Calculator-3.0 + NG86, 5 plot types
├── pi/                       # Nucleotide diversity, hotspot detection
