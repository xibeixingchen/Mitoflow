...
- 精确匹配(<50bp): 515 (66.5%)
- 小偏差(50-100bp): 92 (11.9%)
- 中偏差(100-1000bp): 82 (10.6%)
- 大偏差(>1000bp): 85 (11.0%)
...
**位置偏差>50bp的基因:**
- nad2: 偏差254946bp (large)
- nad1: 偏差201363bp (large)
- ccmfc: 偏差192744bp (large)
- nad5: 偏差187363bp (large)
- rpl2: 偏差2038bp (large)
- cox2: 偏差1400bp (large)
- rps10: 偏差960bp (medium)
- atp6: 偏差492bp (medium)
...
**位置偏差>50bp的基因:**
- ccmfc: 偏差197264bp (large)
- nad1: 偏差89996bp (large)
- cox2: 偏差1400bp (large)
...
**位置偏差>50bp的基因:**
- nad2: 偏差241983bp (large)
- nad1: 偏差205405bp (large)
...
**位置偏差>50bp的基因:**
- nad5: 偏差118200bp (large)
- nad1: 偏差62012bp (large)
- rpl2: 偏差2226bp (large)
- cox2: 偏差1400bp (large)
...
- nad9: 偏差1047853bp (large)
- nad5: 偏差1046829bp (large)
...
| 指标 | Round 2 (线性距离) | Round 2 (环形距离) | 改进 |
|------|-------------------|-------------------|------|
| 精确匹配(<50bp) | 511 (66.0%) | 515 (66.5%) | +4 |
| 小偏差(50-100bp) | 91 (11.8%) | 92 (11.9%) | +1 |
| 中偏差(100-1000bp) | 83 (10.7%) | 82 (10.6%) | -1 |
| 大偏差(>1000bp) | 89 (11.5%) | 85 (11.0%) | -4 |
| A类错误（基因检出） | 444 | 444 | 0 |
| B类错误（位置偏差） | 263 | 259 | -4 |
| C类错误（剪接位点） | 417 | 414 | -3 |
...
- **度量改进**: B类错误减少4个（263 → 259），C类错误减少3个（417 → 414）。这些改进完全来自坐标度量方式的变化，说明部分基因的"大偏差"实际上是因为基因跨越了基因组起点/终点，线性距离夸大了偏差。
- **真实注释改进**: A类错误无变化（444），说明环形距离不影响基因存在性判断。B/C类错误的少量减少属于"度量误差消除"，不应视为注释算法本身的改进。
- **基线意义**: 本报告建立了真实的Round 2基线。后续Round 3的改进应以此环形距离结果（F1=79.51%，B=259，C=414）作为比较基准，避免将度量误差误认为注释精度提升。
