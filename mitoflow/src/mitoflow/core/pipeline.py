...
class AnnotationPipeline:
    ...
    def run(
        ...
        # Note: Trans-spliced gene exon merging is now handled inside annotate_pcg
        # via annotate_trans_spliced_genes function

        # Validate trans-spliced gene exon counts (warnings only)
